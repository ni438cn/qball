...
class Wavefunction {
  ...
  void print_moment(const int statenum, const int a_moment, const int b_moment, const int c_moment) const;
  void print_moments(const int statenum, const int a_moment, const int b_moment, const int c_moment) const;
